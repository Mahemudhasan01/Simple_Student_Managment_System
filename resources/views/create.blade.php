...
<body>
    <div class="container mr-5">
        <h3 class="text-info text-center">Create User</h3>
        ...
        <form action=" {{ route('user.store')}} " method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="fname" class="form-control w-50" id="exampleInputEmail1" aria-describedby="emailHelp"
                    placeholder="Enter Full Name" required>
            </div>

            <div class="form-group">
                <label for="exampleInputEmail1">Phone Number</label>
                <input type="text" name="phone_number" class="form-control w-50" id="exampleInputEmail1" aria-describedby="emailHelp"
            ...
            <div class="form-group">
                ...
                <input type="number" name="age"  class="form-control w-50" id="exampleInputPassword1" placeholder="Enter age between 3 to 30" required>
            </div>
